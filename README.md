...
**Winter** snow melting = higher water level = more dilution 
= less everything more salt into water = less photosynthesis = less oxygen

**Summmer** less rain = lower water level = less dilution 
= higher pollutant concentration = stronger industrial impact

**Heavy rain** heavy rain = sewer overflow + mudslides 
= more turbidity = more nitrates in water = poorer water quality

**Planting period** fertilizer use = rain = runoff into water 
= higher nitrates = risk of eutrophication
